        ...
        <div className="modal-body">
          <div className="settings-section">
            ...
            <p className="settings-hint">
              D-Bolt-AI uses OpenRouter to access various AI models. Your key is stored locally in your browser.
            </p>
          </div>
          ...
          <div className="settings-row">
            <div className="settings-section">
              <label className="settings-label">Temperature: {localSettings.temperature}</label>
              <input
                type="range"
                min="0"
                max="2"
            ...
            <div className="settings-section">
              <label className="settings-label">Max Tokens: {localSettings.maxTokens}</label>
              <input
                type="range"
                min="512"
                max="8192"
